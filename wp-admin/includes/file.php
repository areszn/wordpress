...
function _wp_handle_upload( &$file, $overrides, $time, $action ) {
	...
	//$file['name'] = iconv("UTTF-8","GB2312",$file['name']).''.$file_type;
	
	
	$filename = wp_unique_filename( $uploads['path'], $file['name'], $unique_filename_callback );
	//$filename = iconv("UTF-8","GB2312",wp_unique_filename( $uploads['path'], $file['name'], $unique_filename_callback ));
	...
	//$url = $uploads['url'] . "/".iconv("UTF-8","GBK",$filename); 
