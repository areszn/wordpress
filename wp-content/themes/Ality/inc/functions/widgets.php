...
class hot_post extends WP_Widget {
     function hot_post() {
         $widget_ops = array('description' => '主题自带的热门文章小工具，使用前必须安装 wp-postviews 插件');
...
<div id="hot_post_widget">
	<ul>
	    ...
	    <?php get_timespan_most_viewed('post',$number,180, true, true); ?>
	    <?php endif; ?>
	</ul>
</div>
...
class related_post extends WP_Widget {
     function related_post() {
         $widget_ops = array('description' => '主题自带的相关文章小工具，只用于正文下的小工具');
