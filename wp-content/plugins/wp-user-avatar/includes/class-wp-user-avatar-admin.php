...
class WP_User_Avatar_Admin {
  ...
  public function wpua_admin() {
    add_menu_page(__('用户头像', 'wp-user-avatar'), __('用户头像', 'wp-user-avatar'), 'manage_options', 'wp-user-avatar', array($this, 'wpua_options_page'), WPUA_URL.'images/wpua-icon.png');
    add_submenu_page('wp-user-avatar', __('设置' , 'wp-user-avatar'), __('设置' , 'wp-user-avatar'), 'manage_options', 'wp-user-avatar', array($this, 'wpua_options_page'));
    $hook = add_submenu_page('wp-user-avatar', __('管理','wp-user-avatar'), __('管理', 'wp-user-avatar'), 'manage_options', 'wp-user-avatar-library', array($this, 'wpua_media_page'));
